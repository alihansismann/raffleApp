  ...
  <UContainer class="max-w-xl mt-5">
    ...
    <UForm :validate="validate" :state="state" class="space-y-4" @submit="submitForm">
      ...
      <UFormGroup label="İlgilendiğiniz Ürün" name="favoriteProduct">
        <USelectMenu v-model="state.favoriteProduct" :options="options" />
      </UFormGroup>
...
const options = [
  { label: 'Yazar Kasa Pos', value: 'yazar-kasa-pos' },
  { label: 'Tablet', value: 'tablet' },
  { label: 'E-İmza', value: 'e-imza' },
  { label: 'Kontörlü E-Fatura', value: 'e-fatura' },
  { label: 'Mause', value: 'mause' },
  { label: 'Klavye', value: 'klavye' },
]
